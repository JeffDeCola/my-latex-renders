...
echo "latex f-of-x-equals-x-squared-plus-2-showing-a-tangent-at-x-equals-2.tex"
...
echo "cp f-of-x-equals-x-squared-plus-2-showing-a-tangent-at-x-equals-2.svg ~/cheatsheets/my-cheat-sheets/other/stem/math/pure/changes/calculus-cheat-sheet/svgs/."
