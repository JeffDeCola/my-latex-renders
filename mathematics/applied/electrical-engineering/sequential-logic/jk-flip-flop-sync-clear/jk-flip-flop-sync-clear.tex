...
\resizebox{16cm}{!}{
    ...
    \begin{tikzpicture}[label distance=2mm]
        ...
        \node[my-nand3-gate] (NAND1)       at ($(NAND3OUT) + (3, 0)$)       {\normalsize $nand1$};
        ...
        \node[my-nand3-gate] (NAND2)   at ($(NAND4OUT) + (3, 0)$)       {\normalsize $nand2$};
        ...
        \node[] (PRE) at ($(NAND1IN1) + (0, 2)$)  {\normalsize $pre$};
        \node[] (CLR) at ($(NAND2IN3) + (0, -2)$) {\normalsize $clr$};
        ...
        \draw (NAND3OUT) -- (NAND1IN2) node[pos=0] (S) {};
        \node at ($(S) + (-.2, .3)$) {\normalsize $s$};
        ...
        \draw (NAND1OUTPLUS) -- ($(NAND2OUTPLUS) + (.5,-1.5)$) -- ($(NAND4IN3) + (0,-1.2)$)  -- (NAND4IN3);
        \draw (NAND2OUTPLUS) -- ($(NAND1OUTPLUS) + (-.5,1.5)$) -- ($(NAND3IN1) + (0,1.2)$)   -- (NAND3IN1);
