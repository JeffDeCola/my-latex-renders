...
\resizebox{10cm}{!}{
    ...
    \begin{circuitikz}[scale=1.0, transform shape]
        ...
        %LEFT
        \node[right, font=\tiny\ttfamily]     (DIN0)    at ($(DECODE.blpin 1) + (0, 0)$)     {\normalsize $[2\:0]in$};
        \coordinate[]                         (IN0)     at ($(DECODE.blpin 1) + (-1, 0)$)    {};
        %RIGHT
        ...
        \node[green]  (OUTPUT0)  at ($(OUT1) + (.3, 0)$)  {\normalsize $1$};
        \node[]       (OUTPUT0)  at ($(OUT2) + (.3, 0)$)  {\normalsize $0$};
        \node[]       (OUTPUT0)  at ($(OUT3) + (.3, 0)$)  {\normalsize $0$};
        \node[]       (OUTPUT0)  at ($(OUT4) + (.3, 0)$)  {\normalsize $0$};
        \node[]       (OUTPUT0)  at ($(OUT5) + (.3, 0)$)  {\normalsize $0$};
        \node[]       (OUTPUT0)  at ($(OUT6) + (.3, 0)$)  {\normalsize $0$};
        \node[]       (OUTPUT0)  at ($(OUT7) + (.3, 0)$)  {\normalsize $0$};
