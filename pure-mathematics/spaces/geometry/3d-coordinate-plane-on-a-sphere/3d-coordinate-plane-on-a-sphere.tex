...
\begin{tikzpicture}[scale=6, tdplot_main_coords]
    ...
    \node at (P) [tdplot_screen_coords, color=red!80!black, left = 1mm of P] {$P$};
    \node at (Q) [tdplot_screen_coords, circle, color=green!60!black, fill, inner sep=1.5pt] {};
    \node at (Q) [tdplot_screen_coords, color=green!60!black, right = 1mm of Q] {$Q$};
    ...
    % DRAW CIRCLES (ARCS) ON SPHERE FOR VECTORS
    \tdplotsetthetaplanecoords{\vectorPhiP}
    ...
    % DRAW ARC FROM P TO Q ON SPHERE
